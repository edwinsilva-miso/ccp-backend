...
@seller_bp.route('/deliveries/<uuid:delivery_id>', methods=['GET'])
...
@seller_bp.route('/deliveries/<uuid:delivery_id>', methods=['PUT'])
...
@seller_bp.route('/deliveries/<uuid:delivery_id>', methods=['DELETE'])
...
@seller_bp.route('/deliveries/<uuid:delivery_id>/status', methods=['POST'])
